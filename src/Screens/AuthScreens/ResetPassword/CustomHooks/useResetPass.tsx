...
import {callResetPass, resetClearPassResponse} from '../../../../Redux/Slices/ResetPassSlice';
...
export const useResetPass = (
  ...
  const resetPassSlice = useSelector((state: RootState) => state.resetPassSlice);
  const dispatch = useDispatch();

  const callResetPassApi = (data: {password: string; emailId: string, otp: string}) => {
